...
# ---------------------------------------------------------------------------
# Path setup
# app.py nằm ở d:\UrbanM_AI\backend\
# Các module (backend, database) nằm ở gốc project
# ---------------------------------------------------------------------------
PROJECT_ROOT = Path(__file__).resolve().parent.parent          # d:\UrbanM_AI\
FRONTEND_DIR = PROJECT_ROOT / "frontend"                # d:\UrbanM_AI\frontend\
