...
from backend.core.errors import AlreadyExistsError, NotFoundError, ValidationError
from backend.domain.entities.camera import Camera
from backend.domain.repositories.camera_repository import CameraRepository
