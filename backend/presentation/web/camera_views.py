...
async def api_camera_snapshot(camera_id: int, user=Depends(login_required)):
    ...
    from backend.core.utils import normalize_capture_source
    from backend.services.camera_service import build_placeholder_frame, encode_jpeg, prepare_snapshot_frame
