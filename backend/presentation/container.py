from backend.application.use_cases.camera_use_cases import CameraUseCases
from backend.application.use_cases.dashboard_use_cases import DashboardUseCases
from backend.application.use_cases.job_use_cases import JobUseCases
...
from backend.infrastructure.file_system.local_storage import LocalStorage
from backend.infrastructure.ml.detection_bridge import YoloDetectionService
